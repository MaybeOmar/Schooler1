...
public class StudentRVMaterialAdapter extends RecyclerView.Adapter<StudentRVMaterialAdapter.ViewHolder> {
    ...
    // Constructor
    public StudentRVMaterialAdapter(Context context, ArrayList<String> items, ArrayList<String> urls) {
